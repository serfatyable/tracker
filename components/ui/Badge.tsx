...
export default function Badge({ className, variant = 'default', ...rest }: Props) {
  ...
  const variants: Record<string, string> = {
    ...
    secondary: 'bg-gray-100 text-gray-800 dark:bg-[rgb(var(--surface-elevated))] dark:text-[rgb(var(--fg))]',
    outline: 'ring-1 ring-inset ring-gray-300 text-gray-700 dark:text-[rgb(var(--fg))] dark:ring-[rgb(var(--border))]',
  };
