...
export default function MorningMeetingsView({ showUploadButton = false }: MorningMeetingsViewProps) {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  {t('morningMeetings.exportDescription', { defaultValue: 'Subscribe to get automatic updates in your calendar app' })}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              >
                ...
                <span className="text-sm">{t('morningMeetings.exportMy', { defaultValue: 'My Meetings' })}</span>
              </a>
              ...
              >
                <span className="text-sm">🌐</span>
                <span className="text-sm">{t('morningMeetings.exportAll', { defaultValue: 'All Meetings' })}</span>
              </a>
            </div>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-blue-200 dark:border-blue-800">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              💡 {t('morningMeetings.exportHelp', { 
                defaultValue: 'Copy the link and add it as a calendar subscription in Google Calendar, Apple Calendar, or Outlook' 
              })}
            </p>
          </div>
        </div>
                ...
                {Array.from({ length: meetingsByDay.daysInMonth }, (_, i) => i + 1).map((d) => {
                  ...
                  return (
                    <div 
                      ...
                      `}
                      title={dayMeetings.length > 0 ? t('morningMeetings.clickToView', { defaultValue: 'Click to view details' }) : ''}
                    >
                      <div className={`
