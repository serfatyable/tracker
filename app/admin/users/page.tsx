...
import FixRotationActivations from '../../../components/admin/users/FixRotationActivations';
        ...
        <div className="overflow-x-auto scrollbar-thin mb-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-2 min-w-max">
            ...
            >
              ...
              {t('ui.fixTools', { defaultValue: 'Fix Tools' })}
            </button>
          </div>
        </div>
