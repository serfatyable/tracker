...
const { replaceMock, getCurrentUserWithProfileMock, listUsersMock, listTasksMock, listRotationsMock } = vi.hoisted(() => ({
  replaceMock: vi.fn(),
...
vi.mock('../../../lib/firebase/admin', async () => {
  ...
  return { ...actual, listUsers: listUsersMock, listTasks: listTasksMock, listRotations: listRotationsMock };
});
...
describe('Admin Rotations smoke', () => {
  it('shows rotations tab and lists rotations', async () => {
    ...
    listRotationsMock.mockResolvedValue({ items: [{ id: 'r1', name: 'ICU', startDate: { toDate: () => new Date('2025-01-01') }, endDate: { toDate: () => new Date('2025-06-01') }, status: 'active' }], lastCursor: undefined });
