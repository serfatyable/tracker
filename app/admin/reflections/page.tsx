  ...
  return (
    <AppShell>
      ...
      <div className="app-container p-4 space-y-3">
        <Card>
          <div className="font-semibold mb-2">{t('reflections.latest', { defaultValue: 'Latest' })}</div>
          <div className="text-sm opacity-70">{t('ui.comingSoon', { defaultValue: 'Coming soon' })}</div>
        </Card>
      </div>
    </AppShell>
  );
