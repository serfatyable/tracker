...
const { pushMock, signInMock, signUpMock, requestPasswordResetMock, getCurrentUserWithProfileMock } = vi.hoisted(() => ({
    pushMock: vi.fn(),
    ...
    getCurrentUserWithProfileMock: vi.fn().mockResolvedValue({ firebaseUser: { uid: 'test-user-signin' }, profile: { settings: { language: 'en' } } }),
}));
